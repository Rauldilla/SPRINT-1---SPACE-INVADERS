...
public class SpaceInvadersView extends SurfaceView implements Runnable {
    ...
    private static SimplerButtons buttons;
    ...
    public SpaceInvadersView(Context context, Point size, boolean isAdult) {
        // call SurfaceView
        super(context);

        // 20180926 sgao para controlar que o puede disparar si es juego para niños
    ...
    private void prepareLevel() {
        ...
        for (int column = 0; column < 6; column++) {
            for (int row = 0; row < 5; row++) {
                invaders[numInvaders] = new Invader(context, row, column, screenX, screenY, this.isAdult);
        ...
        if (isAdult) {
            ...
            buttons = new SimplerButtons(context, screenX, screenY);
        }
    }
    ...
    public static long getMenaceInterval() {
        return menaceInterval;
    }

    public static boolean getUhOrOh() {
        return uhOrOh;
    }
